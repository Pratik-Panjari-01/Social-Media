  ...
  return (
    <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scrollbar overflow-x-auto px-4'>
        <div className='flex gap-4 pb-5'>
            ...
            hover:shadow-lg transition-all duration-200 border-2 border-dashed border-indigo-300 bg-gradient-to-b
            ...
            {/* Story Cards */}
            {
                stories.map((story, index)=>(
                    ...
                    hover:from-indigo-700 hover:to-purple-800 active:scale-95`}>
                        <img src={story.user.profile_picture} className='absolute size-8 top-3 left-3 z-10 rounded-full
