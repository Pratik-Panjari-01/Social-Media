...
const ChatBox = () => {
  ...
  useEffect(()=>{
    messagesEndRef.current?.scrollIntoView({behavoiur:"smooth"});
  },[messages])
    ...
    <div className='flex flex-col h-screen'>
      ...
      <div className='p-5 md:px-10 h-full overflow-y-scroll'>
        ...
        <div className='px-4'>
          ...
          max-w-xl mx-auto border-gray-200 shadow rounded-full mb-5'>
            ...
            <label htmlFor="image">
            {
              image ? <img src={URL.createObjectURL(image)} className='h-8 rounded'/> : <ImageIcon className='size-7 cursor-pointer'/>
            }
            ...
            cursor-pointer text-shite p-2 rounded-full'>
