...
export const discoverUsers = async(req,res)=>
{
    try
    {
        ...
        const filiteredUsers = allUsers.filter(user=>user._id !==userId);

        res.json({success:true,users:filiteredUsers});
    }
    catch(error)
    {
        console.log(error);
...
export const sendConnectionRequest = async (req,res) =>
{
    try{
        ...
        {
            return res.json({success:false, message:"You have sent more than 20 connection requests last 24 hours"})
        }
